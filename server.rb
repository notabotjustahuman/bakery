...
cookie4 = Cookie.new("Double Chocolate", "For the Chocolate Lovers", "Price: $1.99", "https://www.gonnawantseconds.com/wp-content/uploads/2022/01/Chocolate-Chocolate-Chip-Cookies-1.jpg")
...
cookie6 = Cookie.new("Oatmeal Raisin", "Plump Raisins with Cinnamon Spice", "Price: $1.95", "https://cdn.sallysbakingaddiction.com/wp-content/uploads/2014/07/oatmeal-raisin-cookies-3.jpg")
...
cupcake4 = Cupcake.new("Double Chocolate", "Chocolate Frosting & Sprinkles", "Price: $3.95", "https://cdn.sallysbakingaddiction.com/wp-content/uploads/2017/06/moist-chocolate-cupcakes-5.jpg")
cupcake5 = Cupcake.new("Chai Latte", "Chai Buttercream and Spice", "Price: $3.95", "https://cdn.sallysbakingaddiction.com/wp-content/uploads/2018/09/chai-latte-cupcakes.jpg")
cupcake6 = Cupcake.new("Dark Chocolate", "Peanut Butter Frosting", "Price: $3.95", "https://cdn.sallysbakingaddiction.com/wp-content/uploads/2017/09/dark-chocolate-cupcakes-peanut-butter-frosting.jpg")
...
cake4 = Cake.new("Coconut", "Fluffy & Soft, Coconut Flakes", "Price: $59.95", "https://cdn.sallysbakingaddiction.com/wp-content/uploads/2019/03/coconut-layer-cake.jpg")
cake5 = Cake.new("Pistacho", "Cream Cheese Frosting with Berries", "Price: $59.95", "https://cdn.sallysbakingaddiction.com/wp-content/uploads/2018/03/homemade-pistachio-cake.jpg")
cake6 = Cake.new("Raspberry Crumb", "Almond and Crumbs Topping", "Price: $59.95", "https://cdn.sallysbakingaddiction.com/wp-content/uploads/2018/04/raspberry-almond-crumb-cake.jpg")
...
crepe4 = Crepe.new("S'mores", "Marshmellow with Crushed Peanuts & Nutella with Chocolate Drizzle", "Price: $8.95", "https://cdn.sallysbakingaddiction.com/wp-content/uploads/2014/08/Smores-Nutella-Crepes-2.jpg")
crepe5 = Crepe.new("Strawberry & Coconut", "Sliced Strawberries & Coconut with Coconut Flakes", "Price: $8.95", "https://www.platingpixels.com/wp-content/uploads/2018/10/Easy-Dairy-Free-Crepes-with-Strawberry-Coconut-Sauce-recipe-6.jpg")
crepe6 = Crepe.new("Strawberry Chocolate", "Rolled Layers with Chocolate Drizzle & Strawberry", "Price: $8.95" "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQo4aze9d78P4224nt-3AWF_-czfXsf8ECMBPMv7bCseggqk4V7")
